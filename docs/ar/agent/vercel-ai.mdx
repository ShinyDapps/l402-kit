---
title: "Vercel AI SDK"
description: "أضف مدفوعات Bitcoin Lightning إلى تطبيق Next.js الذكاء الاصطناعي باستخدام l402-kit."
---
...
راجع [البدء السريع بالمحفظة](/agent/wallet-quickstart) للحصول على محفظة Lightning في 60 ثانية.