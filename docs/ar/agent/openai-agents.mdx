...
description: "استخدم l402-kit مع OpenAI Agents SDK للدفع مقابل واجهات برمجية بشكل مستقل."
---
...
اطّلع على [البدء السريع بالمحفظة](/agent/wallet-quickstart) للحصول على محفظة في 60 ثانية.