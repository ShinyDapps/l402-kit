---
title: "تكامل CrewAI"
description: "استخدم l402-kit مع CrewAI للسماح للوكلاء بالدفع مقابل واجهات برمجة التطبيقات بشكل مستقل."
---
...
راجع [البدء السريع بالمحفظة](/agent/wallet-quickstart) للحصول على محفظة في 60 ثانية.