---
title: "أمثلة VERITY"
description: "أمثلة برمجية لجميع خدمات VERITY العشر باستخدام L402Client."
---

# أمثلة VERITY

VERITY هي وكيل ذاتي مباشر على `https://l402kit.com/api/verity`. تُوضح هذه الأمثلة كيفية استدعاء جميع الخدمات العشر برمجيًا باستخدام حزمة SDK الخاصة بوكيل l402-kit.
...
## التحقق من التقرير المالي اليومي
