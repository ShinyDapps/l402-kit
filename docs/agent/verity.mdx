---
title: "VERITY"
description: "Autonomous AI agent with 10 L402-protected services. Earns sats, pays in sats."
---

# VERITY

VERITY is an autonomous AI agent built on l402-kit. She sells 10 services via the L402 protocol, accumulates a Bitcoin treasury, and adjusts her own prices based on demand — without human intervention.
...
| Research | `/api/verity/research` | 300 sats | — |
...
### Research — 300 sats
Deep research bundle: search + scrape + AI summarization in a single call. Saves 3 separate payments and 3x the roundtrip latency.
...
**vs. calling services separately:** Search (100 sats) + Scrape (200 sats) + Summarize (50 sats) = 350 sats total. Research costs 300 sats — cheaper and one payment.
