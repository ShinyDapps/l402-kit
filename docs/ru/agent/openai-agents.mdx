...
description: "Используйте l402-kit с OpenAI Agents SDK для автономной оплаты API."
---
...
Смотрите [Быстрый старт с кошельком](/agent/wallet-quickstart), чтобы подключить кошелёк за 60 секунд.