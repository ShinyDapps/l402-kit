...
description: "Используйте l402-kit с CrewAI, чтобы агенты могли автономно оплачивать API."
---
...
См. [Быстрый старт с кошельком](/agent/wallet-quickstart), чтобы получить кошелёк за 60 секунд.