---
title: "Vercel AI SDK"
description: "Добавьте платежи Bitcoin Lightning в ваше приложение Next.js AI с помощью l402-kit."
---
...
## Работает с Claude, GPT-4, Gemini
...
См. [Быстрый старт с кошельком](/agent/wallet-quickstart), чтобы получить Lightning-кошелёк за 60 секунд.