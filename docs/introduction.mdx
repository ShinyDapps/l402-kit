...
<Note>
**Full transparency:** In managed mode, ShinyDapps acts as the Lightning routing layer — we receive the payment and forward **99.7%** to your Lightning Address within seconds. The **0.3%** fee keeps the project alive. The split logic is [open source](https://github.com/ShinyDapps/l402-kit) and verifiable. For zero-fee, zero-trust operation, use sovereign mode (Blink, BTCPay, Alby) — payments go directly to your wallet with no intermediary.
</Note>
