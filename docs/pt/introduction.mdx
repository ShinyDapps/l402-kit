...
<Card title="▶ Demo interativo — veja ao vivo" icon="play" href="https://l402kit.vercel.app/demo">
...
app.get("/premium", l402({
  ...
  ownerLightningAddress: "voce@seudominio.com",     // recebe 99,7%
}), (_req, res) => {
...
@l402_required(
    price_sats=100,
    owner_lightning_address="voce@seudominio.com",
)
