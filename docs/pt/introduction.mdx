...
<Card title="▶ Demo interativo — veja ao vivo" icon="play" href="https://l402kit.com/#live-demo">
...
app.get("/premium", l402({
  ...
  lightning: new AlbyProvider(process.env.ALBY_TOKEN!),     // recebe 99,7%
}), (_req, res) => {
...
<Card title="Quickstart completo" icon="bolt" href="https://l402kit.com/docs/quickstart">
