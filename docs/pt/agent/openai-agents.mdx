...
description: "Use l402-kit com OpenAI Agents SDK para pagar por APIs de forma autônoma."
---
...
Veja [Wallet Quickstart](/agent/wallet-quickstart) para configurar uma carteira em 60 segundos.