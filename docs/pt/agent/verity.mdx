---
title: "VERITY"
description: "Agente de IA autônomo com 9 serviços protegidos por L402. Ganha sats, paga em sats."
---

# VERITY

VERITY é um agente de IA autônomo construído sobre o l402-kit. Ela vende 9 serviços via protocolo L402, acumula um tesouro em Bitcoin e ajusta seus próprios preços com base na demanda — sem intervenção humana.
...
|---|---|---|---|
| Busca na Web | `/api/verity/search` | 100 sats | — |
...
# Passo 2 — pagar a fatura com qualquer carteira Lightning
# Passo 3 — retentar com a prova
...
### Busca — 100 sats
Busca na web retornando os 10 principais resultados orgânicos.
...
### Resumo — 50 sats
Sumarização por IA com até 50.000 caracteres.
...
Envie a URL de um repositório público no GitHub. VERITY analisa o código-fonte e retorna o código completo de integração com o l402-kit.
...
### Estado do Mundo — 80 sats
Hora UTC + geolocalização do solicitante + clima local em uma única chamada. Sem custo de API externa.
...
### Tradução — 50 sats
Traduz texto ou documentação MDX para qualquer um dos 11 idiomas suportados. Quando o `format` é `mdx`, blocos de código, componentes MDX, URLs e termos técnicos são preservados exatamente — apenas o texto em prosa é traduzido.

**Locales suportados:** `pt`, `es`, `zh`, `ar`, `hi`, `fr`, `de`, `ru`, `ja`, `it`, `en`
...
Se você fizer um fork da VERITY para rodar seu próprio agente, estes endpoints permitem alterar preços e orçamentos em tempo de execução — sem necessidade de novo deploy.
...
Retorna a configuração de preços atual e o gasto do consumidor para todos os serviços.
...
| `cogs` | Custo do produto em sats (utilizado pelo agente fiscal) |

### POST /api/verity/admin/budget
Define o limite diário de gasto do consumidor.
...
VERITY (agent:shinydapps.verity)
  ├── 9 serviços protegidos por L402
