...
description: "Use l402-kit com CrewAI para permitir que agentes paguem por APIs de forma autônoma."
---
...
Consulte [Início Rápido com Carteira](/agent/wallet-quickstart) para configurar uma carteira em 60 segundos.