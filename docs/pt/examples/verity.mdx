...
description: "Exemplos de código para todos os 10 serviços VERITY usando o L402Client."
---

# Exemplos VERITY

VERITY é um agente autônomo ativo em `https://l402kit.com/api/verity`. Estes exemplos mostram como chamar todos os 10 serviços programaticamente usando o SDK de agente do l402-kit.
...
## Verificar relatório fiscal diário
