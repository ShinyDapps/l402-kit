...
| **Soberano** | Your own Lightning wallet/node | 0% |
...
**Soberano mode**: sign up at [dashboard.blink.sv](https://dashboard.blink.sv) — free, no credit card — and copy your **API Key** and **BTC Wallet ID**.
