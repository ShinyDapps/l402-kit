...
l402-kit is a **sovereign middleware** that adds a Bitcoin Lightning paywall to any HTTP endpoint in 3 lines of code. You bring your own Lightning provider — funds go directly to your wallet, no intermediary required.
...
| Mode | Fee | Setup |
|---|---|---|
| **Sovereign** (any provider) | **0%** — you keep 100% | Bring your own provider credentials |
| **Managed** (`ManagedProvider`) | 0.3% to l402kit.com | No Lightning node — works immediately |

Sovereign mode is the default. Managed mode is an explicit opt-in:

```typescript
// Sovereign — 0% fee, you keep 100%
...
| [BTCPay Server](https://btcpayserver.org) | Self-hosted, full sovereignty |
