...
description: "APIs के लिए स्वायत्त रूप से भुगतान करने के लिए OpenAI Agents SDK के साथ l402-kit का उपयोग करें।"
---
...
60 सेकंड में वॉलेट प्राप्त करने के लिए [Wallet Quickstart](/agent/wallet-quickstart) देखें।