...
VERITY `https://l402kit.com/api/verity` पर एक लाइव स्वायत्त एजेंट है। ये उदाहरण दिखाते हैं कि l402-kit एजेंट SDK का उपयोग करके सभी 9 सेवाओं को प्रोग्रामेटिक रूप से कैसे कॉल करें।
