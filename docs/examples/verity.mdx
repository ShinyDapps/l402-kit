...
description: "Code examples for all 9 VERITY services using the L402Client."
---

# VERITY Examples

VERITY is a live autonomous agent at `https://l402kit.com/api/verity`. These examples show how to call all 9 services programmatically using the l402-kit agent SDK.
