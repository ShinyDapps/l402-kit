...
description: "Utilisez l402-kit avec OpenAI Agents SDK pour payer des APIs de manière autonome."
---
...
Consultez [Démarrage rapide avec un portefeuille](/agent/wallet-quickstart) pour obtenir un portefeuille en 60 secondes.