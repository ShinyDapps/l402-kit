---
title: "Intégration AutoGPT"
description: "Utilisez l402-kit comme plugin ou compétence dans AutoGPT pour un accès autonome aux API payantes."
---

## Concept

AutoGPT et les agents autonomes similaires itèrent sur des tâches et appellent des outils. l402-kit encapsule toute API payante en tant qu'outil appelable — l'agent paie, réessaie et continue sans intervention humaine.
...
## L402Client comme commande compatible AutoGPT
...
Ajoutez ceci au prompt système de votre agent AutoGPT :
...
## Exemple de boucle autonome complète
...
Consultez [Contrôle du budget](/agent/budget) pour les limites de session avancées et [Démarrage rapide avec un portefeuille](/agent/wallet-quickstart) pour obtenir un portefeuille.