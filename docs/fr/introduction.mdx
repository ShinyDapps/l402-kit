...
<Card title="▶ Démo interactive — voir en direct" icon="play" href="https://l402kit.com/#live-demo">
...
app.get("/premium", l402({
  ...
  lightning: new AlbyProvider(process.env.ALBY_TOKEN!),      // vous recevez 99,7%
}), (_req, res) => {
...
<Card title="Guide complet" icon="bolt" href="https://l402kit.com/docs/quickstart">
