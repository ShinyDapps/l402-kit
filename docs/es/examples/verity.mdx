...
description: "Ejemplos de código para los 9 servicios de VERITY usando el L402Client."
---

# Ejemplos de VERITY

VERITY es un agente autónomo en vivo en `https://l402kit.com/api/verity`. Estos ejemplos muestran cómo llamar a los 9 servicios de forma programática usando el SDK de agente de l402-kit.
