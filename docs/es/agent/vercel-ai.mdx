---
title: "Vercel AI SDK"
description: "Agrega pagos Bitcoin Lightning a tu aplicación Next.js con IA usando l402-kit."
---
...
## Next.js App Router — ejemplo completo
...
## Compatible con Claude, GPT-4 y Gemini
...
Consulta [Inicio rápido de billetera](/agent/wallet-quickstart) para obtener una billetera Lightning en 60 segundos.