...
description: "Usa l402-kit con OpenAI Agents SDK para pagar APIs de forma autónoma."
---
...
Consulta [Wallet Quickstart](/agent/wallet-quickstart) para obtener una billetera en 60 segundos.