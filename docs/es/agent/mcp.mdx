---
title: MCP Server
description: Agrega l402-kit como herramienta MCP para que Claude Desktop, Cursor y cualquier IA compatible con MCP pueda pagar APIs Lightning automáticamente.
---
