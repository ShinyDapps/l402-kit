...
<Card title="▶ Demo interactivo — ver en vivo" icon="play" href="https://l402kit.vercel.app/demo">
...
app.get("/premium", l402({
  ...
  ownerLightningAddress: "tu@tudominio.com",       // recibes el 99.7%
}), (_req, res) => {
...
@l402_required(
    price_sats=100,
    owner_lightning_address="tu@tudominio.com",
)
