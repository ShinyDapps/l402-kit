...
<Note>
**Managed mode** (l402kit.com hosts the node, 0.3% fee) is available in the [TypeScript SDK](/sdk/typescript). Python sovereign mode has no fee — payments go directly to your wallet.
</Note>
