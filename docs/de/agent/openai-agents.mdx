...
description: "Verwende l402-kit mit dem OpenAI Agents SDK, um APIs autonom zu bezahlen."
---
...
## TypeScript — vollständiges Beispiel
...
Siehe [Wallet-Schnellstart](/agent/wallet-quickstart), um in 60 Sekunden ein Wallet einzurichten.