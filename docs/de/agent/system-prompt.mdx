...
description: "Füge l402-kit zum System-Prompt deines Agenten hinzu, damit er APIs autonom bezahlt."
---

## Kopiervorlage

Füge dies zum System-Prompt eines beliebigen Agenten hinzu, um autonome L402-Zahlungen zu ermöglichen:
...
Ersetze `{BUDGET_SATS}` durch dein Sitzungsbudget (z. B. `1000` für ~$0,50).
...
- Setze `budgetSats` konservativ — Agenten können Aufrufe schnell ansammeln
- Verwende `spendingReport()`, um die Nutzung am Ende einer Sitzung zu protokollieren
- Für den Produktionseinsatz verwende [BudgetManager](/agent/budget) mit benutzerspezifischen Limits