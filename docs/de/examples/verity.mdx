...
VERITY ist ein live autonomer Agent unter `https://l402kit.com/api/verity`. Diese Beispiele zeigen, wie alle 10 Dienste programmatisch mit dem l402-kit Agent SDK aufgerufen werden.
...
## Täglichen Finanzbericht prüfen
