...
curl -i https://api.l402kit.com/whitepaper-extended
...
const html = await client.fetch("https://api.l402kit.com/whitepaper-extended", {
...
**100 sats** (~$0.10 at current Bitcoin price).
