---
title: "CrewAI インテグレーション"
description: "l402-kit を CrewAI と組み合わせて、エージェントが自律的に API の支払いを行えるようにします。"
---
...
ウォレットを 60 秒で取得するには [ウォレット クイックスタート](/agent/wallet-quickstart) を参照してください。