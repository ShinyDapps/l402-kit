---
title: "Vercel AI SDK"
description: "l402-kit を使って Next.js AI アプリに Bitcoin Lightning 決済を追加します。"
---
...
Lightning ウォレットを 60 秒で取得するには [ウォレットクイックスタート](/agent/wallet-quickstart) を参照してください。