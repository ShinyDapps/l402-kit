...
```
Sovereign mode — you keep 100%, zero fees. Or use `ManagedProvider` for cloud-hosted invoices. Works in **seconds** — while Stripe takes 30 minutes of forms, KYC, and waiting for bank verification.
...
| Major security bug | Low | 392 automated tests across 5 runtimes, SHA256 verification, anti-replay |
