---
title: Providers
description: Two modes — Managed (0.3% flat, no node) or Soberano (0%, your own Lightning node). ManagedProvider, Blink, LNbits, OpenNode, and custom.
---
...
| **Soberano** | Blink | 0% | Free custodial account |
| **Soberano** | LNbits | 0% | Self-host or public instance |
| **Soberano** | OpenNode | 0% | Sandbox testing |
| **Soberano** | Custom | 0% | Any Lightning backend |
...
```python Python
from l402kit.providers.alby import AlbyProvider

alby = AlbyProvider(
    access_token=os.environ["ALBY_ACCESS_TOKEN"],
    hub_url=os.environ["ALBY_HUB_URL"],
)
```
</CodeGroup>
