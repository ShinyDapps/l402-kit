...
go get github.com/shinydapps/l402-kit/go@v1.4.2  # Go / net/http
...
app.get("/premium", l402({
  ...
  lightning: new AlbyProvider(process.env.ALBY_TOKEN!),     // il tuo indirizzo — riceve il 99.7%
}), (_req, res) => {
...
@l402_required(
    price_sats=100,
    lightning=AlbyProvider(os.environ["ALBY_TOKEN"]),
)
