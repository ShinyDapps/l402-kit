...
description: "Usa l402-kit con CrewAI per consentire agli agenti di pagare le API in modo autonomo."
---
...
Consulta [Wallet Quickstart](/agent/wallet-quickstart) per ottenere un wallet in 60 secondi.