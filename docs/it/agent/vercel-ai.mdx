---
title: "Vercel AI SDK"
description: "Aggiungi pagamenti Bitcoin Lightning alla tua app AI Next.js con l402-kit."
---
...
## Next.js App Router — esempio completo
...
## Compatibile con Claude, GPT-4, Gemini
...
Consulta [Wallet Quickstart](/agent/wallet-quickstart) per configurare un wallet Lightning in 60 secondi.