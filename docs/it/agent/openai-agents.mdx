...
description: "Usa l402-kit con OpenAI Agents SDK per pagare le API in modo autonomo."
---
...
Consulta [Wallet Quickstart](/agent/wallet-quickstart) per configurare un wallet in 60 secondi.